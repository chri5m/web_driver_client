defmodule WebDriverClient.JSONWireProtocolClient.Commands.SwitchToParentFrame do
  @moduledoc false
  ...
  def send_request(%Session{id: id, config: %Config{} = config})
      when is_binary(id) do
    client = TeslaClientBuilder.build_simple(config)
    url = "/session/#{id}/frame/parent"
