defmodule WebDriverClient.JSONWireProtocolClient.Commands.TakeScreenshotElement do
  @moduledoc false
  ...
  def send_request(
        ...
        %Element{id: element_id} = _element
      ) do
    client = TeslaClientBuilder.build_simple(config)
    url = "/session/#{session_id}/element/#{element_id}/screenshot"
